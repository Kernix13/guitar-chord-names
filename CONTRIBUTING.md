...
Enter fret numbers for any chord built from the most common scales to return the chord name.

## To Do Items

1. Find scales that are an exact or close match for any chord
1. Generate an SVG version of user's chord
